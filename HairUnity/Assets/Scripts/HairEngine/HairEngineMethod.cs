...
namespace HairEngine
{
    class Func
    {
        [DllImport("SimHair00007", EntryPoint = "InitializeHairEngine")]
        ...
        [DllImport("SimHair00007", EntryPoint = "UpdateParameter", CharSet = CharSet.Ansi)]
        ...
        [DllImport("SimHair00007", EntryPoint = "UpdateHairEngine")]
        ...
        [DllImport("SimHair00007", EntryPoint = "ReleaseHairEngine")]
        ...
        [DllImport("SimHair00007", EntryPoint = "GetHairParticleCount")]
        public static extern int GetHairParticleCount();

        [DllImport("SimHair00007", EntryPoint = "GetParticlePerStrandCount")]
        public static extern int GetParticlePerStrandCount();

        [DllImport("SimHair00007", EntryPoint = "InitCollisionObject")]
