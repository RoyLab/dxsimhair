...
if __name__ == "__main__":
    ...
    if needLoad:
        ...
        frames = importFile("E:/cache/329.xml", n_frame)
        ...
        for fn in range(len(frames)):
            ...
            frames[fn].cacheInfo(file(".dump/329frame"+str(fn)+".dump", 'wb'))
            for k in graph.keys():
        ...
        pkl.dump(graph, file('329data.test', 'w'))
    ...
    pkl.dump(mgraph, file('329mgA.test', 'w'))
    pkl.dump(mpgraph, file('329mgB.test', 'w'))
